...
long pop (Stack * this_Stack, long * item) {
    ...
    *item= this_Stack[(this_Stack[STACK_POINTER_INDEX])-1];/*sets pointer to 
    ...
    /*if debug is on and a negative number is on top of the stack then debug
     * message will print*/
    if (debug && *item < 0){
        fprintf(stderr, HEXPOP, (long)stack_counter, *item);/*prints
	hexadecimal output*/
    }
...
long push (Stack * this_Stack, long item) {
     ...
     * message will print*/
    if (debug && item < 0){
        fprintf(stderr, HEXPUSH, (long)stack_counter, item);/*prints
	hexadecimal output*/
    }
...
long top (Stack * this_Stack, long * item) {
    ...
    *item= this_Stack[(this_Stack[STACK_POINTER_INDEX])-1];/*pointer to item is
     ...
     * message will print*/
    if (debug && *item < 0){
        fprintf(stderr, HEXTOP, (long)stack_counter, *item);/*prints
	hexadecimal output*/
    }
    return 1;/*returns true for success*/
